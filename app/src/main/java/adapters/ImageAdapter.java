...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.SimpleViewHolder>{
        ...
        public void onBindViewHolder(final SimpleViewHolder holder, final int position) {
            String url = MainNavigationActivity.filmSelected.getMedias().get(position).getPath();
            ...
            ImageRequest request = new ImageRequest(url,
                    ...
                    new Response.ErrorListener() {
                        public void onErrorResponse(VolleyError error) {
                            holder.imageView.setImageResource(R.drawable.a15c6213);
                        }
                    });
// Access the RequestQueue through your singleton class.
        ...
        public int getItemCount() {
            return MainNavigationActivity.filmSelected.getMedias().size();
        }
    }
