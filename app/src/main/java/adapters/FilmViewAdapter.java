...
public class FilmViewAdapter extends RecyclerView.Adapter<FilmViewAdapter.ViewHolder> {
    ...
    private final FilmFragment.OnFilmSelectedListener mListener;

    public FilmViewAdapter(List<Film> films, FilmFragment.OnFilmSelectedListener listener) {
        mValues = films;
        mListener = listener;
    }
        ...
        ImageRequest request = new ImageRequest(url,
                ...
                new Response.ErrorListener() {
                    public void onErrorResponse(VolleyError error) {
                        holder.mImageView.setImageResource(R.drawable.a15c6213);
                    }
                });
